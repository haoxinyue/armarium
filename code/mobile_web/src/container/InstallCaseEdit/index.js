...
import {changeHeaderRight, compeleteInstallCaseDetail, getDeviceDetail, getInstallCaseDetail, uploadFile} from '../../redux/actions'
...
class DeviceEdit extends Component {
    ...
    save() {
        const {dispatch,history, match: {params: {caseId}}} = this.props;
    ...
    componentWillReceiveProps(nextProps, nextState) {
        const {dispatch, match: {params: {caseId}}, installCase, userInfo} = this.props;
        ...
        let info = caseId && installCase.byIds[caseId];
        if (info) {
            console.log("update----");
            let formValue = {
