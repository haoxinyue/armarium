import {
  queryInstallCaseDetail,
  queryInstallCaseList,
  addInstallCase,
  compeleteInstallCase,
  closeInstallCase,
} from '../services/installCase';

export default {
  namespace: 'installCase',
  ...
  effects: {
    *fetch({ payload }, { call, put }) {
      const response = yield call(queryInstallCaseList, payload);
      yield put({
        type: 'save',
        payload: response,
      });
    ...
    *fetchDetail({ payload, callback }, { call, put }) {
      const response = yield call(queryInstallCaseDetail, {
    ...
    *add({ payload }, { call, put }) {
      const response = yield call(addInstallCase, payload) || {};
    ...
    *complete({ payload, callback }, { call, put }) {
      const response = yield call(compeleteInstallCase, payload) || {};
      yield put({
        type: 'saveCurrent',
        payload: response.data,
      });
    ...
    *close({ payload, callback }, { call, put }) {
      const response = yield call(closeInstallCase, payload);
      yield put({
        type: 'saveCurrent',
        payload: response.data,
      });
